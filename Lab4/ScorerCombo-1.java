...
public class ScorerCombo {
	...
	public static String result(int inning, int visitorScore, int homeScore) {
		if (visitorScore > homeScore){
			return("Visiting team won the game " + visitorScore + " to " + homeScore);
		}
		else{
			return("Home team won the game " + homeScore + " to " + visitorScore);
		}
		// Your code goes here.
	...
	public static void main(String[] args) {
		...
		if (answer.charAt(0) == 'y' || answer.charAt(0) == 'Y') {
			...
			innings(visitorScores);
			System.out.println((result(visitorScores, homeScores)) + " in " + innings(visitorScores) + " innings ");
		}
